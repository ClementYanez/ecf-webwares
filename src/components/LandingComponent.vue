...
.image-wrapper:nth-child(1) img {
  opacity: 1;
  /* Premier élément totalement visible */
}

.image-wrapper:nth-child(2) img {
  opacity: 0.7;
  /* Deuxième élément légèrement transparent */
}

.image-wrapper:nth-child(3) img {
  opacity: 0.3;
  /* Troisième élément plus transparent */
}

.image-wrapper:nth-child(4) img {
  opacity: 0.2;
  /* Quatrième élément encore plus transparent */
}
...
.box-shadow {
  ...
  /* Assure que l'arrière-plan soit blanc */
  padding: 80px;
  ...
  /* Transition pour un effet lors du survol */
  display: flex;
  /* Ne prend que la largeur et la hauteur nécessaires */
